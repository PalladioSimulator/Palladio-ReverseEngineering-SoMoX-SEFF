...
The parsing process takes Java code and parses it with the JDT parser, which is direclty traversed by the AST2SEFF visitor pattern to output different SEFFs as XML. It is more similar to the MoDisco version again.
