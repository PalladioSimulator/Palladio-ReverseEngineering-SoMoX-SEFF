 ...
 * <ul>
 *   <li>{@link eu.qimpress.qimpressgast.impl.GASTBehaviourRepositoryImpl#getGastbehaviour <em>Gastbehaviour</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GASTBehaviourRepositoryImpl extends EObjectImpl implements GASTBehaviourRepository {
	...
	protected EClass eStaticClass() {
		return qimpressgastPackage.Literals.GAST_BEHAVIOUR_REPOSITORY;
	}
	...
	public EList<GASTBehaviour> getGastbehaviour() {
		if (gastbehaviour == null) {
			gastbehaviour = new EObjectContainmentEList<GASTBehaviour>(GASTBehaviour.class, this, qimpressgastPackage.GAST_BEHAVIOUR_REPOSITORY__GASTBEHAVIOUR);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case qimpressgastPackage.GAST_BEHAVIOUR_REPOSITORY__GASTBEHAVIOUR:
