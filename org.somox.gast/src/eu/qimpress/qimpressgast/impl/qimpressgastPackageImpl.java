...
public class qimpressgastPackageImpl extends EPackageImpl implements qimpressgastPackage {
	 ...
	 * @see eu.qimpress.qimpressgast.qimpressgastPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private qimpressgastPackageImpl() {
		super(eNS_URI, qimpressgastFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link qimpressgastPackage#eINSTANCE} when that field is accessed.
	...
	public static qimpressgastPackage init() {
		if (isInited) return (qimpressgastPackage)EPackage.Registry.INSTANCE.getEPackage(qimpressgastPackage.eNS_URI);

		// Obtain or create and register package
		qimpressgastPackageImpl theqimpressgastPackage = (qimpressgastPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof qimpressgastPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new qimpressgastPackageImpl());
		...
		theqimpressgastPackage.createPackageContents();

		// Initialize created meta-data
		theqimpressgastPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theqimpressgastPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(qimpressgastPackage.eNS_URI, theqimpressgastPackage);
		return theqimpressgastPackage;
	}
