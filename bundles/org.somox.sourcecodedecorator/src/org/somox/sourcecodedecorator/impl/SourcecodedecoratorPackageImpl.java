...
public class SourcecodedecoratorPackageImpl extends EPackageImpl implements SourcecodedecoratorPackage {
    ...
    public static SourcecodedecoratorPackage init() {
		...
		Object registeredSourcecodedecoratorPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SourcecodedecoratorPackageImpl theSourcecodedecoratorPackage = registeredSourcecodedecoratorPackage instanceof SourcecodedecoratorPackageImpl ? (SourcecodedecoratorPackageImpl)registeredSourcecodedecoratorPackage : new SourcecodedecoratorPackageImpl();
