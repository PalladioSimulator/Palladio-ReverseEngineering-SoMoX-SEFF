...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Component Candidate</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
...
public interface ComponentCandidate extends EObject {
    /**
     * Returns the value of the '<em><b>Metric Values</b></em>' containment reference list. The list
     * contents are of type {@link metricvalues.MetricValue}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Metric Values</em>' containment reference list isn't clear, there
    ...
    /**
     * Returns the value of the '<em><b>First Component</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>First Component</em>' reference isn't clear, there really should
    ...
    /**
     * Sets the value of the '{@link metricvalues.ComponentCandidate#getFirstComponent
     * <em>First Component</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>First Component</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Second Component</b></em>' reference. <!-- begin-user-doc
     * -->
     * <p>
     * If the meaning of the '<em>Second Component</em>' reference isn't clear, there really should
     * be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link metricvalues.ComponentCandidate#getSecondComponent
     * <em>Second Component</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Second Component</em>' reference.
