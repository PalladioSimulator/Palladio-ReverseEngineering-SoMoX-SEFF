...
public interface MetricvaluesFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Component Candidate</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Metric Value</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Metric Values Model</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
