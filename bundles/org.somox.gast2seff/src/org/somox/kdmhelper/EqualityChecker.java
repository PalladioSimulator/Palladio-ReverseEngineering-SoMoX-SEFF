...
public class EqualityChecker {
	...
	public static boolean areFunctionsEqual(final Method function1, final Method function2) {
		...
		if (!targetInTypeReferenceEquals(getReturnTypeAccess(function1), getReturnTypeAccess(function2)) || !checkParametersEqual(function1, function2)) {
			return false;
		}
	...
	private static boolean targetInTypeReferenceEquals(final TypeReference typeRef1, final TypeReference typeRef2) {
		...
		if ((typeRef1.getTarget() == null) || (typeRef2.getTarget() == null) || !typeEquals(typeRef1.getTarget(), typeRef2.getTarget())) {
			return false;
		}
		return true;
	}
