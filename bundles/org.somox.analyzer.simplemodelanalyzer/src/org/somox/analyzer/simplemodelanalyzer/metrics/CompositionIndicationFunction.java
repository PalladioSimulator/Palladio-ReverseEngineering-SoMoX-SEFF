...
/**
 * Function calculating weights indicating the composition of two component candidates. <br>
...
public class CompositionIndicationFunction implements ICompositionFunction {
    ...
    public double computeOverallDirectedMetricValue(final Map<MetricID, Double> metricValues) {
        ...
        final double sum = this.getMaxNameResemblanceWeigth() + interfaceAdherenceWeight + subsystemComponentWeight
                + this.packageMappingWeight + this.DMSWeight + this.directoryMappingWeight;
        if (sum == 0) {
        ...
        if (logger.isTraceEnabled()) {
            ...
            logger.trace("DMS = " + dms + " * " + this.DMSWeight + " = " + dms * this.DMSWeight);
        ...
        double score = nameResemblanceAfterCoupling + interfaceAdherence * interfaceAdherenceWeight
                ...
                dms * this.DMSWeight + directoryMapping * this.directoryMappingWeight;
