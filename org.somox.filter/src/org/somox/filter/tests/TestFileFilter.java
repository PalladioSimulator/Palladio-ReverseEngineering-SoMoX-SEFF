...
public class TestFileFilter extends BaseFilter<ConcreteClassifier> {
    ...
    /**
     * The detectors that are used to determine whether a file is a test file. Because
     * ordering affects performance, this is not a set.
     */
    ...
    public boolean passes(ConcreteClassifier object) {
        final Path compilationUnitPath = EmfResource.getPath(object.getContainingCompilationUnit().eResource());
