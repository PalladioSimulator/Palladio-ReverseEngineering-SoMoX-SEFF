...
public interface IAssemblyConnectorStrategy {
     ...
     *            The SAM model element representing the composite component found
     * @param compositeComponentSubgraph
     *            The graph of relations between the subcomponents of the composite component used
     *            when detecting the composite component
     */
    public void buildAssemblyConnectors(ComponentImplementingClassesLink compositeComponentCandidate,
