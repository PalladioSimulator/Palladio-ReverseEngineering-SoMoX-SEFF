...
public class MethodLevelSourceCodeLinkImpl extends FileLevelSourceCodeLinkImpl implements MethodLevelSourceCodeLink {
	 ...
	 * @generated
	 */
	public Classifier getFunction() {
		if (function != null && function.eIsProxy()) {
			InternalEObject oldFunction = (InternalEObject)function;
			function = (Classifier)eResolveProxy(oldFunction);
	 ...
	 * @generated
	 */
	public Classifier basicGetFunction() {
		return function;
	}
	 ...
	 * @generated
	 */
	public void setFunction(Classifier newFunction) {
		Classifier oldFunction = function;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SourcecodedecoratorPackage.METHOD_LEVEL_SOURCE_CODE_LINK__OPERATION:
				...
				return;
			case SourcecodedecoratorPackage.METHOD_LEVEL_SOURCE_CODE_LINK__FUNCTION:
				setFunction((Classifier)newValue);
				return;
		}
