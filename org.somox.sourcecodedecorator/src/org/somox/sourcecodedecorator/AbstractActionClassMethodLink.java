 ...
 * </p>
 * <ul>
 * <li>{@link org.somox.sourcecodedecorator.AbstractActionClassMethodLink#getClassMethod
 * <em>Class Method</em>}</li>
 * <li>{@link org.somox.sourcecodedecorator.AbstractActionClassMethodLink#getAbstractAction
...
public interface AbstractActionClassMethodLink extends EObject {
    /**
     * Returns the value of the '<em><b>Class Method</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Class Method</em>' reference isn't clear, there really should be
     ...
     * <em>Class Method</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Class Method</em>' reference.
     * @see #getClassMethod()
     * @generated
     */
