...
public class SourcecodedecoratorSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case SourcecodedecoratorPackage.SEFF2_METHOD_MAPPING: {
                SEFF2MethodMapping seff2MethodMapping = (SEFF2MethodMapping)theEObject;
                T result = caseSEFF2MethodMapping(seff2MethodMapping);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case SourcecodedecoratorPackage.SEFF_ELEMENT_SOURCE_CODE_LINK: {
                SeffElementSourceCodeLink seffElementSourceCodeLink = (SeffElementSourceCodeLink)theEObject;
                T result = caseSeffElementSourceCodeLink(seffElementSourceCodeLink);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    public T caseMethodLevelResourceDemandingInternalBehaviorLink(
            MethodLevelResourceDemandingInternalBehaviorLink object) {
        return null;
    }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>SEFF2 Method Mapping</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>SEFF2 Method Mapping</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseSEFF2MethodMapping(SEFF2MethodMapping object) {
        return null;
    }

    /**
     * Returns the result of interpreting the object as an instance of '<em>Seff Element Source Code Link</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Seff Element Source Code Link</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseSeffElementSourceCodeLink(SeffElementSourceCodeLink object) {
        return null;
    }
