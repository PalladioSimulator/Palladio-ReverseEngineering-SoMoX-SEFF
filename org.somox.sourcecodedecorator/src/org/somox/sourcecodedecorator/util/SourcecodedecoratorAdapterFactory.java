...
public class SourcecodedecoratorAdapterFactory extends AdapterFactoryImpl {
    ...
    protected SourcecodedecoratorSwitch<Adapter> modelSwitch = new SourcecodedecoratorSwitch<Adapter>() {
        ...
        public Adapter caseMethodLevelResourceDemandingInternalBehaviorLink(
            ...
            return SourcecodedecoratorAdapterFactory.this
     ...
     * <em>Source Code Decorator Repository</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
     ...
     * <em>Data Type Source Code Link</em>}'. <!-- begin-user-doc --> This default implementation
     * returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
     ...
     * <em>Inner Datatype Source Code Link</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
     ...
     * <em>Abstract Action Class Method Link</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
     ...
     * <em>Abstract Method Level Source Code Link</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
