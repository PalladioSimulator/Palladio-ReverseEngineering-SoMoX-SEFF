 ...
 * {@link org.somox.analyzer.simplemodelanalyzer.ui.ExtendableCompleteSimpleModelAnalysisJob#BEFORE_ALL_JOBS_EXTENSION_ID}
 * . Performs injected test logic when being executed.
 *
 * @author Joshua Gleitze
 */
public class TestStartExtendingJob extends AbstractWorkflowExtensionJob<SoMoXBlackboard> {
    ...
    public void execute(final IProgressMonitor monitor) throws JobFailedException, UserCanceledException {
        ...
        ExtendableCompleteSimpleModelAnalysisJobTest.reportCall(TestStartExtendingJob.class);
        if (logic != null) {
