 ...
 * <ul>
 *   <li>{@link eu.qimpress.sourcecodedecorator.impl.SourceCodeDecoratorRepositoryImpl#getFileLevelSourceCodeLink <em>File Level Source Code Link</em>}</li>
 *   <li>{@link eu.qimpress.sourcecodedecorator.impl.SourceCodeDecoratorRepositoryImpl#getMethodLevelSourceCodeLink <em>Method Level Source Code Link</em>}</li>
 *   <li>{@link eu.qimpress.sourcecodedecorator.impl.SourceCodeDecoratorRepositoryImpl#getControlFlowLevelSourceCodeLink <em>Control Flow Level Source Code Link</em>}</li>
 *   <li>{@link eu.qimpress.sourcecodedecorator.impl.SourceCodeDecoratorRepositoryImpl#getInterfaceSourceCodeLink <em>Interface Source Code Link</em>}</li>
 *   <li>{@link eu.qimpress.sourcecodedecorator.impl.SourceCodeDecoratorRepositoryImpl#getComponentImplementingClassesLink <em>Component Implementing Classes Link</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
