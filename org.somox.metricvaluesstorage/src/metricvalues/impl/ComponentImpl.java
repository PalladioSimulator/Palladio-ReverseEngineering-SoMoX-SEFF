...
public class ComponentImpl extends EObjectImpl implements Component
{
    ...
    * @ordered
    */
   protected static final GASTClass[] CLASSES_EEMPTY_ARRAY = new GASTClass [0];
    ...
    * @generated
    */
   public GASTClass[] getClasses()
   {
      if (classes == null || classes.isEmpty()) return CLASSES_EEMPTY_ARRAY;
      BasicEList<GASTClass> list = (BasicEList<GASTClass>)classes;
      list.shrink();
      return (GASTClass[])list.data();
   }
    ...
    * @generated
    */
   public GASTClass getClasses(int index)
   {
    ...
    * @generated
    */
   public void setClasses(GASTClass[] newClasses)
   {
      ((BasicEList<GASTClass>)getClassesList()).setData(newClasses.length, newClasses);
   }
    ...
    * @generated
    */
   public void setClasses(int index, GASTClass element)
   {
    ...
    * @generated
    */
   public EList<GASTClass> getClassesList()
   {
      if (classes == null)
      {
         classes = new EObjectResolvingEList<GASTClass>(GASTClass.class, this, MetricvaluesPackage.COMPONENT__CLASSES);
      }
      return classes;
   }
   ...
   public void eSet(int featureID, Object newValue)
   {
      switch (featureID)
      {
         ...
         case MetricvaluesPackage.COMPONENT__CLASSES:
            ...
            getClassesList().addAll((Collection<? extends GASTClass>)newValue);
            return;
      }
