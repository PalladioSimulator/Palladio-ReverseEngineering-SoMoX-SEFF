		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SEFF2MethodMapping_blockstatement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SEFF2MethodMapping_blockstatement_feature", "_UI_SEFF2MethodMapping_type"),
				 Seff2javaastPackage.Literals.SEFF2_METHOD_MAPPING__BLOCKSTATEMENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Seff2javaastPackage.Literals.SEFF2_METHOD_MAPPING__SEFF,
				 true,
				 false,
				 true,
				 null,
